  ...
  <?php if (!empty($nodes)): ?>
    <ul id="portfolio_items" class="clearfix">
      ...
      foreach ($nodes as $node) :
        ...
        ?>
        <li data-id="id<?php print $node->nid; ?>" class="four columns portfolio-item <?php print portfolio_format_terms('field_portfolio_category', $node); ?>" data-type="web-design">
